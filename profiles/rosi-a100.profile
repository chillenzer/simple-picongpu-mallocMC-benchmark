...
# Hack try to trick this into loading OpenMPI
# while it is not available on ampere.
module load genoa
...
ml use /data/rosi/shared/eb/easybuild/ampere/modules/all/Core/*
ml nvidia-compilers/25.1-CUDA-12.6.0

export LD_LIBRARY_PATH=/data/rosi/shared/eb/easybuild/ampere/software/GCCcore/13.3.0/lib64:$LD_LIBRARY_PATH
