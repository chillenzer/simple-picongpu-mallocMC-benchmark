...
> **Status.** The recommendation in §6 was implemented: `analysis/performance_model.py`
...
> (H, E, L, T, Q) is a first-class part of the model (`performance_model.FADE_SHAPES`),
